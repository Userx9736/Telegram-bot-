# bot.py – Safe multi‑proxy version (dumpoir removed)
...
# ═══════ INSTAGRAM PROXY LIST (safe, no spam) ═══════
# Only use these – they don't redirect to gambling / phishing sites.
IG_PROXIES = [
    "instagram.com",        # original (0)
    "ddinstagram.com",      # reliable mirror
    "imginn.com",           # alternative mirror
]
